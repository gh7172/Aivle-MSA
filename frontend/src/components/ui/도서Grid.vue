                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="Plot">{{ val.plot }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">도서 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="PublishDate" v-model="selectedRow.publishDate" :editMode="true"/>
                            <String label="Plot" v-model="selectedRow.plot" :editMode="true"/>
